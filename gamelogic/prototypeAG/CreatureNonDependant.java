...
public class CreatureNonDependant extends Creature implements SurvivalInstinct {
    ...
    public static int getAgressiveness() {
        return agressiveness;
    }

    public static void setAgressiveness(int value) throws Exception {
        if (value < 0 || value > 10) {
            throw new Exception("Invalid value provided. Value of agressiveness must be in range [0, 10].");
        }
        CreatureNonDependant.agressiveness = value;
    }
